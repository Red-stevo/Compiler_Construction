...
public class ZaraParserLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IF", "ELSE", "WHILE", "FOR", "RETURN", "CONST", "GLOB", "IN", "STRING", 
			"ARRAY", "STACK", "ELSE_IF", "DO", "CONTINUE", "CLASS", "INT", "ASSIGN", 
			"EQ", "GT", "LT", "GTE", "LTE", "PLUS", "MINUS", "MULT", "DIV", "AND", 
			"NOT", "DOT", "OR", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "SEMICOLON", 
	...
	public ZaraParserLexer(CharStream input) {
		super(input);
